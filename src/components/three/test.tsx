...
// Define the vertex shader (basic vertex shader in Three.js)
const vertexShader = `
void main() {
...
const Nebula = () => {
	...
	const { scene, size } = useThree() // Utiliser 'size' pour les dimensions de la vue
	...
	}, [scene, window.innerWidth, window.innerHeight]) // Dépendances de useEffect
...
// Define the fragment shader (converted GLSL to TypeScript/Three.js)
// const fragmentShader = `
// #define SCREEN_EFFECT 0
...
// }
// `
// Setup Three.js scene, camera, renderer, and uniforms
